...
use pete_events::{
    ...
    BrainEventPayload, BrainEventRecordKind, BrainEventType, ClockedTime, EventDisposition,
    EventTimes, LossPolicy, PayloadReference, ProducerIdentity, TrustState,
...
include!("server/observatory_stress.rs");
