...
mod tests {
    ...
    async fn live_routes_include_3d_and_scene_endpoints() {
        ...
        assert!(
            page.contains("TransformCoordinates(kinectCameraPointToBabylonLocal(p), robotMatrix)")
        );
