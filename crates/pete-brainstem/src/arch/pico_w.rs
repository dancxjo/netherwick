...
$('clearcharge').onclick=()=>sendCockpit({kind:'clear_safety_latch',latch:'charging'}).then(requestStatus)
...
fn render_handshake_welcome<'a>(
    ...
    let (estop_latched, safety_tripped, motion_interlock_latched) =
