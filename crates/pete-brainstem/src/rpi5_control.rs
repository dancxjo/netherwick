...
fn compact_status(seq: u32) -> String {
    ...
    format!(
        concat!(
            "OK {} STATUS uptime_ms={} clock_epoch=0 runtime={} body={} action={} command={} pending={} ",
            ...
            "forebrain_rx_lines={} odometry_resets={} odometry_distance_mm={} odometry_x_mm={} ",
            "odometry_y_mm={} odometry_heading_mrad={} imu_present={} imu_health={} imu_samples={} imu_sample_ms={} imu_age_ms={} ",
            ...
            "imu_calibration={} imu_orientation_confidence={} imu_gyro_bias_calibrated={} ",
            "imu_mounting_calibrated={} imu_orientation_source={} firmware_version={} git_commit={} git_dirty={} build_id={} ",
