...
impl DreamConfig {
    pub fn from_env(seed: u64) -> Self {
        Self {
            seed,
            weirdness: env_f32("NETHERWICK_DREAM_WEIRDNESS", 0.35),
            density: env_f32("NETHERWICK_DREAM_DENSITY", 0.5),
            sociality: env_f32("NETHERWICK_DREAM_SOCIALITY", 0.3),
            hazard_bias: env_f32("NETHERWICK_DREAM_HAZARD_BIAS", 0.25),
            charger_bias: env_f32("NETHERWICK_DREAM_CHARGER_BIAS", 0.2),
        }
        .clamped()
    }
